...
class getQuery_BusService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['query.bus'] = new \Symfony\Component\Messenger\MessageBus(new RewindableGenerator(function () use ($container) {
            ...
            yield 1 => ($container->privates['query.bus.middleware.add_bus_name_stamp_middleware'] ??= new \Symfony\Component\Messenger\Middleware\AddBusNameStampMiddleware('query.bus'));
            ...
            yield 6 => ($container->privates['query.bus.middleware.send_message'] ?? $container->load('getQuery_Bus_Middleware_SendMessageService'));
            yield 7 => ($container->privates['query.bus.middleware.handle_message'] ?? $container->load('getQuery_Bus_Middleware_HandleMessageService'));
        }, 8));
    }
}
