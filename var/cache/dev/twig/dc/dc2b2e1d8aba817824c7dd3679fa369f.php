...
class __TwigTemplate_ffd114033b56f0466781d9f1bc9656ae extends Template
{
    private $source;
    private $macros = [];
...
{%- macro render_table_triggered_handlers(handlers) -%}
    ...
    {%- endfor -%}
{%- endmacro -%}
", "@JMSSerializer/Collector/handlers.html.twig", "/home/john/Desktop/crypto (копия)/vendor/jms/serializer-bundle/Resources/views/Collector/handlers.html.twig");
    }
}
