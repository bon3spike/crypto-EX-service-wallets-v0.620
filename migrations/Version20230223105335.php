 ...
 */
final class Version20230223105335 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE address_mixing (id INT AUTO_INCREMENT NOT NULL, wallet_id INT NOT NULL, mixorder_id INT NOT NULL, number INT NOT NULL, address VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, percentage INT NOT NULL, delay TIME NOT NULL, wallets_ids VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, INDEX IDX_6BF6E7AA712520F3 (wallet_id), INDEX IDX_6BF6E7AA7EF396F5 (mixorder_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
