...
use App\Repository\OutputTransactionRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: OutputTransactionRepository::class)]
class OutputTransaction
{
    ...
    #[ORM\ManyToOne(inversedBy: 'outputTransaction')]
    #[ORM\JoinColumn(nullable: false)]
    private ?Wallets $sender_wallet = null;
    ...
    public function getSenderWallet(): ?Wallets
    {
        return $this->sender_wallet;
    }

    public function setSenderWallet(?Wallets $sender_wallet): self
    {
